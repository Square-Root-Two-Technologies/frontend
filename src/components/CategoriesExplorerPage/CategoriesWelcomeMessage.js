...
const CategoriesWelcomeMessage = () => {
  return (
    <div className="card h-full flex flex-col items-center justify-center text-center min-h-[50vh]">
      ...
      <p className="text-subtle max-w-md">
        Please select a category or a specific blog post from the sidebar on the
        left to view its content here.
      </p>
    </div>
  );
};

export default CategoriesWelcomeMessage;
